...
public class CreateOrganizationContactCommand : IRequest<bool>
{
...
public class CreateOrganizationContactCommandHandler : IRequestHandler<CreateOrganizationContactCommand, bool>
{
    private readonly IApplicationDbContext _context;
    private readonly ISender _sender;
    public CreateOrganizationContactCommandHandler(IApplicationDbContext context, ISender sender)
    {
        _context = context;
        _sender = sender;
    }
    public async Task<bool> Handle(CreateOrganizationContactCommand request, CancellationToken cancellationToken)
    {
